# MindLayer Positioning & Messaging Guide v1.0
...
Every answer MindLayer produces shows the exact source — paragraph, page, document. No black boxes. Researchers cite with confidence because they know where every fact originates.

**Research-grade accuracy**
Built on Corrective-RAG: self-critique + web fallback. When the answer isn't in your documents, MindLayer tells you and points to where it went looking. Uncertainty is displayed, not hidden.

**Your knowledge, amplified**
MindLayer indexes what you already know — notes, papers, emails, annotations — and surfaces connections you forgot you made. The insight was always there. Now you can find it.
...
| Dimension | MindLayer | Typical AI Tools |
|---|---|---|
...
**Messaging:** "Mem helps you capture. MindLayer helps you *find* what you already captured."
...
**Messaging:** "Notion AI writes in your workspace. MindLayer searches *across* your workspace."

---

#### vs. Obsidian Copilot

| | **Obsidian Copilot** | **MindLayer** |
|---|---|---|
...
**Messaging:** "Obsidian Copilot queries your vault. MindLayer reasons *across* your vault and the web when needed."

---

#### vs. General AI (ChatGPT, Claude, etc.)

| | **General AI** | **MindLayer** |
|---|---|---|
...
**Messaging:** "ChatGPT knows everything. MindLayer knows *what you know*."
...
> MindLayer turns your personal knowledge into a searchable, reasoning, answerable brain — with receipts for every answer.

**Supporting message 1 — Source transparency**

> Every answer MindLayer gives comes with a citation. Not "the model said so" — the exact paragraph from your document. Copy it. Cite it. Trust it.

**Supporting message 2 — Confidence calibration**

> MindLayer shows its confidence score on every answer. When it's uncertain, you see it. No confident wrong answers hiding behind a polished response.

**Supporting message 3 — Connection discovery**

> MindLayer connects what you know. Ask "How does the market analysis from March relate to the customer interviews in May?" and get a reasoned answer — not a keyword search.
...
> "You spent three years accumulating papers, notes, and datasets. MindLayer turns that stack into a searchable, answerable knowledge base — with citations that hold up to peer review."
...
> "Your competitive intelligence lives in 400 client documents. MindLayer indexes all of it and answers questions like 'Which clients mentioned regulatory risk in Q2?' with exact sources."
...
> "Your advisor asks a question about your literature review. MindLayer answers from your annotated PDFs and notes — with citations."
...
> "Your team's institutional knowledge — reports, meeting notes, research — stays accessible even when the person who wrote it isn't around. MindLayer indexes it. Answers it. Cites it."
...
**Extended:** Type a question. MindLayer searches your indexed documents and returns an answer — with the specific paragraph, page, and document highlighted. Every claim backed by a receipt.
...
**Short:** Know when MindLayer is sure — and when it's guessing.
...
**Extended:** "How does X relate to Y?" isn't a single search — it's a reasoning chain. MindLayer traces the connection, shows each step, and cites sources at every hop.
...
**Short:** "What did I conclude in Q1?" — MindLayer knows when you wrote what.

**Extended:** Temporal memory means MindLayer understands *when* things happened in your knowledge base. Ask time-bound questions and get answers scoped to specific periods.
...
**Extended:** No folder restructuring. No manual tagging. No workspace redesign. MindLayer indexes your documents as they are. Ask questions in plain English.
...
- Say what MindLayer does well. Don't overstate ("revolutionize") or hedge ("might help").
- Example — Good: "MindLayer cites every answer to your own documents."  
  Example — Bad: "MindLayer will totally transform the way you do research forever."

**Transparent about limitations**

- Acknowledge uncertainty openly. "MindLayer didn't find this in your documents, so it searched the web" is a feature, not a failure.
...
| **Error state** | Calm, transparent, actionable | "MindLayer couldn't access your document store right now. This usually resolves in a few minutes. [Retry →]" |
| **Empty state (no results)** | Constructive | "MindLayer didn't find anything matching that query. Try rephrasing, or check if the relevant documents are indexed." |
...
**Subheadline:**
> MindLayer is the RAG-native answer engine that searches your documents, reasons across them, and shows you exactly where it found every answer — including when it went to the web to find more.
...
**Medium (≤50 words):**
> MindLayer answers your questions by searching across all your indexed documents — and shows you the exact paragraph that supports each claim. No hallucination risk. No mystery sources. Just evidence-backed answers.

**Long (landing page):**
> MindLayer's Q&A engine searches your entire personal knowledge base — papers, notes, PDFs, annotations, emails — and returns answers grounded in your own documents. Every claim is backed by an exact paragraph citation. Tap to expand the source. Copy the citation. Trust the answer.
...
**Short:**
> When your documents don't have the answer, MindLayer searches the web and tells you it did.

**Medium:**
> MindLayer's Corrective-RAG first checks your documents. If the answer isn't there, it transparently escalates to a web search — and shows you exactly where it went and what it found. No silent failures. No confident hallucinations. Just honest answers.
...
**Medium:**
> "How does X relate to Y?" requires reasoning, not a single keyword search. MindLayer traces connections across your documents, shows each step in the reasoning chain, and cites sources at every hop.
...
**Short:**
> "What did I conclude in Q1?" MindLayer knows when you wrote what.

**Medium:**
> Your knowledge has a timeline. MindLayer's temporal memory indexes not just *what* you wrote, but *when*. Ask time-bound questions and get answers scoped to specific periods — without manual date filters or folder archaeology.
...
**Short:**
> Every answer comes with a confidence score. When MindLayer doesn't know, you see it.

**Medium:**
> MindLayer displays a calibrated confidence score on every answer — so you know whether the answer is well-grounded in your documents or needs further investigation. High confidence: answer is strongly supported. Low confidence: transparent escalation or disclaimer.
...
**Subject:** Welcome to MindLayer — your knowledge base is ready

**Body:**

> Hi [Name],
>
> MindLayer is set up and ready. Here's what to do next:
>
> **1. Index your documents**
> Drag and drop papers, PDFs, notes, and reports into MindLayer. It indexes everything and makes it searchable.
>
...
> Every answer MindLayer gives includes the exact paragraph from your document. If the confidence score is high, you can cite it directly.
>
...
**Subject:** 3 questions MindLayer can answer from your research

**Body:**

> Hi [Name],
>
> You joined MindLayer [X days] ago but haven't asked a question yet. Here's what you might be wondering:
>
> 1. **"Did I already research this?"** — Ask MindLayer. It searches your full knowledge base.
> 2. **"What did I conclude in [quarter/month]?"** — MindLayer's temporal memory knows.
> 3. **"How does A relate to B?"** — Multi-hop reasoning traces the connection with citations.
>
> → [Go to MindLayer and ask a question]
>
> — The MindLayer Team
...
> Hi [Name],
>
> You asked for time-aware search. MindLayer's Temporal Memory is now live.
>
> **What it does:**
> MindLayer now tracks *when* content was written, not just *what* was written. Ask "What did I conclude about market dynamics in Q1?" and get answers scoped to that period — no manual date filtering needed.
>
> **How it works:**
> Temporal Memory indexes document metadata, annotation dates, and note timestamps. When you ask a time-bound question, MindLayer scopes retrieval to the relevant period and shows you exactly which documents it drew from.
>
> **Example:**
...
> MindLayer knows when you wrote what.
> Temporal memory is live. Try it: [link]

**Post 3 (competitive):**
> ChatGPT knows everything.
> MindLayer knows what *you* know.
> With receipts.
> [brief comparison graphic]

**Post 4 (social proof / use case):**
> A PhD student told us:
> "I spent 20 minutes trying to find where I cited that paper. MindLayer found it in 3 seconds and showed me the exact paragraph."
> That is the product.
...
> I couldn't find it.
>
> That's the problem MindLayer solves.
>
> Not "another AI that writes for you" or "AI that summarizes your meetings."
> MindLayer is a RAG-native answer engine that:
...
| Error State | Message |
|---|---|
| **Document index failed** | "MindLayer couldn't index '[filename]'. This file may be corrupted or in an unsupported format. [Supported formats →]" |
| **No results found** | "MindLayer didn't find anything matching your question in your documents. Try rephrasing, or check if the relevant documents are indexed." |
| **Web fallback triggered** | "MindLayer didn't find a strong answer in your documents, so it searched the web. Here's what it found: [answer]." |
| **Low confidence answer** | "MindLayer found something related, but confidence is low (47%). [Show what it found] [Refine your question →]" |
| **Service unavailable** | "MindLayer is temporarily unavailable. Your indexed documents are safe — this usually resolves in a few minutes. [Retry →]" |
| **Session expired** | "Your session expired. Sign in again to continue. [Sign in →]" |
| **Rate limit** | "You've made many queries in a short time. MindLayer will be ready to answer again shortly. [Learn about limits →]" |
...
- Comparison pages: "MindLayer vs. [Obsidian / Notion AI / Mem / ChatGPT]" — honest, feature-matrix style
...
**Objective:** Help the prospect understand MindLayer is the right fit — specifically for researchers who need source transparency.

**Core message:**
> MindLayer isn't another AI assistant. It's a RAG engine that answers questions from your documents, shows its work, and tells you when it doesn't know.
...
- Case study: "[Researcher Name], [Title]" — used MindLayer to answer "[specific question]" in "[time saved]"
- FAQ page: "Does MindLayer train on my data?" → "No. Your documents stay private."
...
- Pricing page: Frame as time saved, not cost — "A researcher saves [X hours/week] searching their own documents. MindLayer costs less than one hour of consultant time."
...
**Core message:**
> MindLayer gets better the more you ask.

**Tactics:**
- In-app prompts: "You haven't asked a temporal question yet. Try: 'What did I write about [topic] in [quarter]?'"
- Periodic digest: "This week, MindLayer answered [X] questions. Top query area: [topic]. [See all →]"
...
- Annual review nudge: "Your MindLayer knowledge base contains [X documents]. Ask: 'What were my key findings this year?'"
...
**Bridge to MindLayer:**
> "Most researchers we talk to say the same thing: 'I know I read it somewhere, I just can't find it.' That's the exact problem MindLayer was built for."

**Feature highlights (lead with pain, not feature):**

| Pain | MindLayer Feature | One-liner |
|---|---|---|
| "I can't find that citation I wrote" | Q&A + citations | "MindLayer shows you the exact paragraph." |
| "I don't trust AI answers" | Confidence calibration | "Every answer has a confidence score. When MindLayer doesn't know, you see it." |
| "ChatGPT doesn't know my documents" | Personal knowledge RAG | "MindLayer answers from *your* documents, not training data." |
| "My knowledge is scattered" | Unified index | "Index papers, PDFs, notes — MindLayer searches across all of it." |
...
> "The confidence score for this answer is [X%] — which means MindLayer found relevant content but it's not a strong match. You might want to try rephrasing the question, or check if the relevant document is indexed."

**Web fallback explanation:**
> "MindLayer first searches your personal documents. If it doesn't find a strong answer, it transparently escalates to the web and shows you exactly where it looked. You'll see the confidence score change and a note that web search was used."

**Privacy question:**
> "Your documents stay private. MindLayer indexes them locally or in your private cloud — it never uses your personal documents to train its models. The RAG engine retrieves from your index, not from training data."
...
> "That's great — MindLayer doesn't replace your note-taking tool. It indexes *output* from those tools and makes it searchable and answerable. If you've already got a vault full of knowledge in Obsidian, MindLayer can index it and let you ask questions across it with citations. No need to change your workflow."

#### "ChatGPT already does this with custom GPTs"

> "Custom GPTs can reference documents, but they don't show you *which paragraph* the answer came from — and they have no confidence calibration. When ChatGPT doesn't find something in your documents, it silently falls back to its training data and sounds equally confident. MindLayer shows a confidence score and explicitly tells you when it escalated to the web."

#### "This sounds complicated to set up"

> "That's the most common concern — and it's wrong. MindLayer indexes documents automatically as you add them. No folder restructuring, no manual tagging, no taxonomy to maintain. You index your documents, you ask questions. That's the entire setup."

#### "How is this different from a vector database?"

> "A vector database stores embeddings. MindLayer builds on top of that with Corrective-RAG — self-critique, confidence calibration, and web fallback. If MindLayer can't answer from your documents, it tells you and searches the web. A vector database alone doesn't do any of that."

#### "We have compliance / data privacy concerns"

> "MindLayer is RAG-native, not training-dependent. Your documents are used for retrieval, not training. We support [self-hosting / private cloud / on-premise] options for enterprise compliance requirements. Happy to walk through the security architecture in detail."
...
**Primary logo:**
MindLayer wordmark — horizontal lockup on light backgrounds; white wordmark on dark backgrounds.
...
- Use real screenshots of the MindLayer interface wherever possible
...
*End of MindLayer Positioning & Messaging Guide v1.0*
