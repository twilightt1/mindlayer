...
3. ✅ **Import paths** — Rewind/Limitless/OpenRecall exports; ChatGPT/Claude/Gemini memory exports (PAM mappings). (backend done 2026-09-04: ChatGPT/Claude/generic/PAM adapters + `POST /api/v1/imports`; Rewind/Limitless adapter blocked on official export format — SQLCipher; UI upload page pending)
