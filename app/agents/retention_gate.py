...
class RetentionGateChecker:
    ...
    def __init__(self, gate: Optional[RetentionGate] = None):
        self.gate = gate or RetentionGate()
        self._metrics = RetentionMetrics()
        self._baseline_metrics: Optional[RetentionMetrics] = None
    ...
    def evaluate(self, metrics: Optional[RetentionMetrics] = None) -> RetentionGateReport:
        """
